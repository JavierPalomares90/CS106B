...
/* Returns a queue containing singleton trees for all the characters */
HuffmanPQueue getQueue(Map<ext_char, int>& frequencies);

/* Returns the optical encoding tree */
Node* getTree(HuffmanPQueue queue);

/* Finds the encoding for a character */
bool findEncoding(ext_char ch, Node* encodingTree, string& result);

/* Finds the character for and encoding */
